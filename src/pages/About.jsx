  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8">
            ...
            >
              ...
              >
                ...
                <p className="text-base md:text-lg text-gray-700 leading-7 md:leading-8 mt-5">
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              <article className="bg-white/90 backdrop-blur-md p-6 md:p-8 rounded-3xl shadow-lg border border-white/50 text-center hover:-translate-y-2 hover:shadow-2xl transition duration-300">
        ...
        <section
          className="py-24 bg-red-700 text-white"
